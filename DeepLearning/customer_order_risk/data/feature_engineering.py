...
import pandas as pd
import numpy as np
from DeepLearning.customer_order_risk.config import FEATURE_CONFIG
class FeatureEngineer :
    ...
    def create_features(self, df):
        ...
        high_discount = df["disicount"] > df["discount"].quantile(FEATURE_CONFIG["high_discount_threshold"])
    ...
    def prepare_model_data(self, df):
        feature_columns = [
            "unit_price", "quantity", "diiscount", "total_amount", "diiscount_amount", "avg_order_amount", "std_order_amount", "total_spent",
